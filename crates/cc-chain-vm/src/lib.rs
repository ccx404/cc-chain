//! CC Chain Virtual Machine - Smart contract execution and WASM runtime
//!
...
impl SmartContractVM {
    ...
    pub fn inter_contract_call(
        ...
        caller: String,
        origin: String,
    ) -> Result<crate::interop::InterContractResult> {
    ...
    pub fn query_events(
        &self,
        filter: &EventFilter,
    ) -> Result<crate::events::EventQueryResult> {
    ...
    pub fn register_event_listener(
        &mut self,
        contract_address: String,
        listener: crate::events::EventListener,
    ) -> Result<()> {
        self.event_manager
    ...
    pub fn get_interop_stats(&self) -> &crate::interop::InterContractStats {
