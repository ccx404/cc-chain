...
mod tests {
    ...
    fn test_supported_chain_ids() {
        ...
        assert_eq!(SupportedChain::BinanceSmartChain.chain_id(), 56);
    ...
    fn test_bridge_creation() {
        ...
        assert_eq!(bridge.validators.len(), 0);
        assert_eq!(bridge.assets.len(), 0);
    }
    ...
    fn test_transfer_initiation() {
        ...
        let config = BridgeConfig {
            chain_pair: (
                ...
                SupportedChain::Custom("CCChain".to_string()),
            ),
        ...
        bridge.add_bridge_config(config);
        ...
        let asset = CrossChainAsset {
            ...
            decimals: 18,
            native_chain: SupportedChain::Ethereum,
        ...
        assert!(bridge.get_transfer(&transfer_id).is_some());
    }
